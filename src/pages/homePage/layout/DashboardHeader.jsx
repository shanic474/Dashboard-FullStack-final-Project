    ...
    <div className="bg-linear-to-r from-[#2a2a2a] via-[#2d2d2d] to-[#2a2a2a] border-b border-amber-500/20 sticky top-0 z-40">
      <div className="px-6 py-4 flex items-center justify-between">
        <div className="pb-2 border-b border-amber-500/20">
          <h1 className="text-3xl font-light text-white tracking-wide uppercase">Dashboard</h1>
          <p className="text-gray-400 mt-1 text-sm font-light">Welcome to Build-Your-Own Meal Store</p>
        </div>

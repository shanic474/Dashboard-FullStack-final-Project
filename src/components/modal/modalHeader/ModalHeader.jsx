...
const ModalHeader = ({ user, onClose }) => {
  return (
    <div className="p-4 sm:p-5 border-b border-amber-500/20 bg-linear-to-r from-amber-500/5 via-transparent to-amber-500/5 shrink-0">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3 sm:space-x-4">
          {/* User Avatar */}
          <div className="w-14 h-14 sm:w-16 sm:h-16 bg-linear-to-br from-amber-500/20 to-yellow-500/20 border-2 border-amber-500/40 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">

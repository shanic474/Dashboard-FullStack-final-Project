        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <div className="flex-1 min-w-0">
            <label className="text-s font-light text-gray-500 tracking-wide block mb-0.5 sm:mb-1">
              Full Name:
              <EditableInput name="user_name" isEditable={isModalEditable} />
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="relative bg-linear-to-br from-gray-900/50 via-[#1a1a1a]/50 to-gray-900/50 p-3 sm:p-4 border border-amber-500/10 rounded-sm hover:border-amber-500/30 transition-all">
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <div className="flex-1 min-w-0">
            <label className="text-s font-light text-gray-500 tracking-wide block mb-0.5 sm:mb-1">
              Email Address
              <EditableInput name="user_email" isEditable={isModalEditable} />
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2 sm:gap-3">
        ...
        <div className="relative bg-linear-to-br from-gray-900/50 via-[#1a1a1a]/50 to-gray-900/50 p-3 sm:p-4 border border-amber-500/10 rounded-sm hover:border-amber-500/30 transition-all">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="flex-1 min-w-0">
              <label className="text-s font-light text-gray-500 uppercase tracking-wide block mb-0.5 sm:mb-1">
                Total Orders
              </label>
              <p className="sm:text-lg font-light text-gray-300 font-mono break-all">
                {"total_orders" || "N/A"}
              </p>
            </div>
          </div>

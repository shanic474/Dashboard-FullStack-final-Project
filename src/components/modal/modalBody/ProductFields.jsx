        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {isModalEditable ? (
              ...
              <p className="text-base sm:text-lg font-light text-gray-400 normal-case">
                No image
              </p>
            )}
          </div>
      ...
      <div className="relative bg-gradient-to-br from-gray-900/50 via-[#1a1a1a]/50 to-gray-900/50 p-3 sm:p-4 border border-amber-500/10 rounded-sm hover:border-amber-500/30 transition-all">
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <EditableInput name="product_name" isEditable={isModalEditable} />
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              {isModalEditable ? (
                ...
                <span
                  className={`inline-block px-2 sm:px-3 py-1 text-xs sm:text-sm font-light rounded-sm ${getStockColor(
      ...
      <div className="relative bg-gradient-to-br from-gray-900/50 via-[#1a1a1a]/50 to-gray-900/50 p-3 sm:p-4 border border-amber-500/10 rounded-sm hover:border-amber-500/30 transition-all">
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-lg sm:text-sm font-light text-gray-300 font-mono break-all">
              {product._id || "N/A"}
            </p>
          </div>
        </div>
